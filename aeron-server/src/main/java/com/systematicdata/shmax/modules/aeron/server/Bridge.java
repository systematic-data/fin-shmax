...
/**
 * Main entry point of the bridge.
 *
 * The bridge transfers messages from one communication channel and stream to other communication
 * channel and stream.
 *
 * It's useful to republish point-to-point UDP messages to Multicast, for example or to other
 * bridges to jump over the network barriers.
 */
public class Bridge {
    private static final Logger log = LoggerFactory.getLogger(Bridge.class);


    public Bridge(final String args[]) throws IOException {
